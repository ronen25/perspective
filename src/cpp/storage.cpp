...
t_lstore_recipe::t_lstore_recipe(const t_str& dirname, const t_str& colname,
...
t_lstore_recipe::t_lstore_recipe(const t_str& colname, t_uindex capacity,
...
void t_lstore::set_size(t_uindex idx) // in bytes
{
    PSP_TRACE_SENTINEL();
...
// nontrivial alignment
    ...
    {
        memset(static_cast<t_uchar*>(m_base) + ocapacity, 0,
